                    ...
                    @if($cat->is_parent>0)
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-banner">
                                @if($cat->photo)
                                    <img src="{{$cat->photo}}" alt="{{$cat->photo}}" style="width: 350px; height:350px" >
                                @else
                                    <img src="https://via.placeholder.com/600x370" alt="#">
                                @endif
                                <div class="content">
                                    <h3 class="text-white-50">{{$cat->title}}</h3>
                                        <a href="{{route('product-cat',$cat->slug)}}" class="text-success">Discover Now</a>
                                </div>
                            </div>
                        </div>
                    @endif
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="button-head">
                                                <div class="product-action">
                                                    ...
                                                    <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" ><i class=" ti-heart "></i><span>Tambah ke Daftar Keinginan</span></a>
                                                </div>
                                                <div class="product-action-2">
                                                    <a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}">Keranjang</a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                ...
                                <div class="button-head">
                                    ...
                                    <div class="product-action-2">
                                        <a href="{{route('add-to-cart',$product->slug)}}">Keranjang</a>
                                    </div>
                                </div>
                            </div>
                            <div class="product-content">
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            <div class="quickview-ratting-wrap">
                                                ...
                                                <a href="#"> ({{$rate_count}} ulasan pembeli)</a>
                                            </div>
