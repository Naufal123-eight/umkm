								...
								@if(Helper::getAllProductFromCart())
									...
									<track>
										...
										<td class="float-right">
											<button class="btn float-right" type="submit">Perbaharui</button>
										</td>
									</track>
								@else
										<tr>
											<td class="text-center">
												Tidak Ada Barang Di Keranjang. <a href="{{route('product-grids')}}" style="color:blue;">Lanjutkan Berbelanja</a>
											</td>
										</tr>
								@endif
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Anda Menghemat<span>Rp{{number_format(Session::get('coupon')['value'],2)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Total Pembayaran<span>Rp{{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">Total Pembayaran<span>Rp{{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
