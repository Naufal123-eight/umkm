...
@section('title','UMKM || PRODUK PAGE')
						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								@if(count($products))
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	...
																	<a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Tambah ke Daftar Keinginan</span></a>
																</div>
									...
									@endforeach
								@else
									<h4 class="text-warning" style="margin:100px auto;">Tidak ada produk sekarang.</h4>
								@endif
							</div>
							 <div class="row">
