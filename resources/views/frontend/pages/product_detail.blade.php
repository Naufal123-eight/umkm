...
<script>
    // Inisialisasi peta
    var map = L.map('map').setView([{{ $product_detail->latitude }}, {{ $product_detail->longitude }}], 15);
    ...
    // Menambahkan marker pada koordinat toko
    L.marker([{{ $product_detail->latitude }}, {{ $product_detail->longitude }}]).addTo(map)
