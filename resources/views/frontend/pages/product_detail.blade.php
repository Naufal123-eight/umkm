...
@endsection
@section('title','UMKM || PRODUK DETAIL')
@section('main-content')
		...
		<section class="shop single section">
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                <h4 class="mt-4">{{$product_detail->store}} <i class="ti-shopping-cart"></i></h4>
                                                <hr>
											</div>
											<!--/ End Description -->
											<!-- Color -->
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	Anda harus <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Masuk</a> Atau <a style="color:blue" href="{{route('register.form')}}">Registrasi</a>
                    ...
                    <div class="container mt-4">
                        <div id="map" class="mx-auto" style="height: 370px; width: 80%;"></div>
                    </div>
		</section>
		<!--/ End Shop Single -->
...
<script>
   var lat = {{ $product_detail->latitude ?? 'null' }};
    var lng = {{ $product_detail->longtitude ?? 'null' }};

    // Cek apakah koordinat berisi angka
    if (!isNaN(lat) && !isNaN(lng)) {
        var map = L.map('map').setView([parseFloat(lat), parseFloat(lng)], 15);
        ...
        L.marker([parseFloat(lat), parseFloat(lng)]).addTo(map)
            .bindPopup('<b>{{ $product_detail->store }}</b><br>{{ $product_detail->address }}')
            .openPopup();
    } else {
